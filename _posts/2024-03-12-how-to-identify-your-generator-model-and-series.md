...
### Step 1: Locate the Engine Nameplate
Every industrial gas engine leaves the factory with a permanent identification plate (nameplate) securely riveted to the engine block or crankcase housing. 

* **Where to look:** Typically, the nameplate is positioned near the control panel, on the main crankcase door, or adjacent to the flywheel housing.
* **What it contains:** The nameplate is your primary source of truth. It displays the exact serial number, engine type/series (such as Type 3 or Type 6 architecture), year of manufacture, and specific performance ratings. 

Never rely solely on general enclosure labels or external skid branding, as ancillary packaging can change while core engine blocks remain specific to their production generation.
...
Beyond the main engine nameplate, major sub-assemblies often carry their own sub-component tags:
* **Turbochargers:** Often supplied by secondary manufacturers (such as ABB or Napier), these carry separate identification plates crucial for procuring overhaul kits.
* **Ignition Systems & Actuators:** Electronic control modules and throttle bodies have specific firmware and hardware revisions. 
